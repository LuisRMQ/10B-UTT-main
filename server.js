...
const estudiantesRouter = require('./app/routers/estudiante');  
const colaboradoresRouter = require('./app/routers/colaborador');  

const Log = require('./app/models/Log');
const Backup = require('./app/models/Backup');
app.use('/estudiante', estudiantesRouter);  
app.use('/colaborador', colaboradoresRouter);  
